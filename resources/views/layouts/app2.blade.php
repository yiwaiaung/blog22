    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                @else
                    <li class="nav-item ">
                        <a class="nav-link" data-toggle="collapse" href="#ui-account" aria-expanded="false" aria-controls="ui-basic">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="auth">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="/posts/create"> Post Add </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/posts">Post List</a>
                            </li>
